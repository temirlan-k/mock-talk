...
function HeyGen() {
    ...
    async function fetchAccessToken() {
        try {
            const response = await fetch('https://mock-talk.onrender.com/get-access-token', {
                method: 'POST'
            });
    ...
    const sendMessage = async () => {
        ...
        try {
            const response = await axios.post('https://mock-talk.onrender.com/chat', {
    ...
    async function handleUploadFile() {
        ...
        try {
            const response = await axios.post('https://mock-talk.onrender.com/upload-resume/', formData);
